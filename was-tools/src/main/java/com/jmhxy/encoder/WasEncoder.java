...
/* 55 */     this.spriteCount = spriteCount;
/* 56 */     this.frameCount = frameCount;
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/* 87 */     for (Image image : images) {
/* 88 */       addFrame(image, 1);
/*    */     }
/*    */   }
/*    */   
/*    */   public void addFrame(Image image, int delay) {
/* 93 */     this.images.add(image);
/* 94 */     this.delays.add(Integer.valueOf(delay));
/*    */   }
/*    */   
...
/* Location:              D:\Desktop\WasTools2.0-all.jar!\com\jmhxy\encoder\WasEncoder.class
